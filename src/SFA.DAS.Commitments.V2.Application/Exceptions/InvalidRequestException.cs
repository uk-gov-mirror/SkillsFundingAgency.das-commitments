...
{
    //todo: consider moving this into another, shared, assembly, or adding a reference to v2 from v1 application assembly so that the equivalent can be deleted from there.
