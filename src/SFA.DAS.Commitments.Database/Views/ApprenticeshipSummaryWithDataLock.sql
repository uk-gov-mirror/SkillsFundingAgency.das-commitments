...
-- not expecting this to survive, but allows us to proceed for now with a working
-- [GetAlertsSummary] && [GetProviderAlertsSummary]
	CREATE VIEW [dbo].[ApprenticeshipSummaryWithDataLock]
AS 
